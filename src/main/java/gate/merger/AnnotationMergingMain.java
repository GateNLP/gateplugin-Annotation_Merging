...
@CreoleResource(name="Annotation Merging PR", comment="Merge Annotations from different annotators.", helpURL="http://gate.ac.uk/userguide/sec:misc-creole:merging")
public class AnnotationMergingMain extends AbstractLanguageAnalyser implements
  ...
  @Optional
  @RunTime
  @CreoleParameter(comment="Annotation sets names used for merging. Example: 'as1;as2;as3'. If not defined, use all the annotation sets but the default annotation set.")
  ...
  @RunTime
  @CreoleParameter(comment="Annotation set name used for storing the merged annotations")
  ...
  @RunTime
  @Optional
  @CreoleParameter(comment="Annotation types names and optionally features used for merging. Example: 'Location;Organisation->type'.")
  ...
  @RunTime
  @CreoleParameter(comment="MergingByAnnotatorNum selects the annotation on which at least minimalAnnNum annotators agree and MajorityVoting selects the annotation that the majority of annotators support.", defaultValue="MajorityVoting")
  ...
  @RunTime
  @Optional
  @CreoleParameter(comment="Minimal number of annotators who must agree to merge the annotation with MergingByAnnotatorNum mergingMethod", defaultValue="1")
  ...
  @RunTime
  @CreoleParameter(comment="Should source annotations be kept when merged?", defaultValue="true" )
